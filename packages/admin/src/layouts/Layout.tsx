...
const menuItems = [
  ...
  },
  {
    ...
    children: [
      { key: '/admin/promotion?tab=qrcodes', icon: <QrcodeOutlined />, label: '二维码管理' },
      { key: '/admin/promotion?tab=emails', icon: <MailOutlined />, label: '邮件营销' },
...
const menuLabelMap: Record<string, string> = {
  ...
  '/admin/promotion?tab=qrcodes': '二维码管理',
  '/admin/promotion?tab=emails': '邮件营销',
  '/admin/promotion?tab=articles': '文章管理',
